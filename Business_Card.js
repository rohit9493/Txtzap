										...
										<div className="row">
											...
											<div className="form-group col-md-4">
												<input
													...
													onChange={handleChange}
												/>
												<label>Website* (Ref link :https://www.facebook.com/)</label>
											</div>
											...
											<div className="form-group col-md-4">
												<input
													...
													onChange={handleChange}
												/>
												<label>Facebook (Ref link :https://www.facebook.com/)</label>
											</div>
											...
											<div className="form-group col-md-4">
												<input
													...
													onChange={handleChange}
												/>
												<label>Twitter (Ref link :https://www.facebook.com/)</label>
											</div>
											...
											<div className="form-group col-md-4">
												<input
													...
													onChange={handleChange}
												/>
												<label>Pinterest (Ref link :https://www.facebook.com/)</label>
											</div>
											...
											<div className="form-group col-md-4">
												<input
													...
													onChange={handleChange}
												/>
												<label>Youtube (Ref link :https://www.facebook.com/)</label>
											</div>
											<div className="form-group col-md-4">
												<input
													type="url"
													...
													onChange={handleChange}
												/>
												<label>Instagram (Ref link :https://www.facebook.com/)</label>
											</div>
											<div className="form-group col-md-4">
												<Image
													...
													fluid
													width="225"
													className={formdata.profile ? 'image-padding' : 'hidden'}
												/>
												<Dropzone onDrop={(acceptedFiles) => onDropprofile(acceptedFiles)}>
												...
												<label>
													Profile <small>Prefered Logo Size is (225 X 220)</small>
												</label>
											</div>
											<div className="form-group col-md-4">
												<Image
